...
// import {} from "@/app/api/auth/[...nextauth]/route"; // Adjust path to your NextAuth config
// import { options } from "@/app/api/auth/[...nextauth]/options";

// // Base configuration
// const BASE_URL = "/api";
// // const USERS_SERVER_URL = process.env.NEXT_PUBLIC_USERS_SERVER_URL;
...
//   const fullUrl = `${customBaseUrl || BASE_URL}${url}`;
...
async function baseFetch(
  ...
  console.log("Fetching from URL:", fullUrl); // Debug the URL
